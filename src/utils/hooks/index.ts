...
export const useSearchLocation = () => {
  ...
  useEffect(() => {
    setLoading(true)
    fetch(
      `https://api.mapbox.com/geocoding/v5/mapbox.places/${searchText}.json?fuzzyMatch=true&access_token=pk.eyJ1IjoibWlycm9yMDUiLCJhIjoiY2x5YTFvNWZ0MDJndjJpc2Jtczd2eDhvbSJ9.HB8MJNnc-fFtha5xZlmujA`,
    )
